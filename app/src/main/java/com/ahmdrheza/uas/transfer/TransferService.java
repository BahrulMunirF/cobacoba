package com.ahmdrheza.uas.transfer;
...
import com.ahmdrheza.uas.bundle.Bundle;
import com.ahmdrheza.uas.bundle.FileItem;
import com.ahmdrheza.uas.discovery.Device;
...
public class TransferService extends Service {
    ...
    public static final String ACTION_START_LISTENING = "com.ahmdrheza.uas.START_LISTENING";
    public static final String ACTION_STOP_LISTENING = "com.ahmdrheza.uas.STOP_LISTENING";

    public static final String ACTION_START_TRANSFER = "com.ahmdrheza.uas.START_TRANSFER";
    public static final String EXTRA_DEVICE = "com.ahmdrheza.uas.DEVICE";
    public static final String EXTRA_URIS = "com.ahmdrheza.uas.URLS";
    public static final String EXTRA_ID = "com.ahmdrheza.uas.ID";

    public static final String ACTION_STOP_TRANSFER = "com.ahmdrheza.uas.STOP_TRANSFER";
    public static final String ACTION_REMOVE_TRANSFER = "com.ahmdrheza.uas.REMOVE_TRANSFER";
    public static final String EXTRA_TRANSFER = "com.ahmdrheza.uas.TRANSFER";

    public static final String ACTION_BROADCAST = "com.ahmdrheza.uas.BROADCAST";
